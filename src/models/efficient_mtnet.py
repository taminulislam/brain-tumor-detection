...
1. Enhanced Learning-to-Downsample with Squeeze-and-Excitation
2. Multi-Scale Feature Aggregation Neck
3. LightHam (Hamburger) Head for efficient global context modeling
4. Auxiliary heads for deep supervision
5. Efficient depthwise separable convolutions
